      ...
      <div className='row'>
        ...
        <div className='col col--4'>
          ...
          <div className={styles.title_left}>
            ...
            <div className={styles.desc}>根据行业特性和工作流进行精准调优</div>
            <div className={styles.desc}>与企业战略目标保持高度一致性</div>
            {/* <Link
              key='start'
              className={clsx(~
                'button--primary',
        ...
        <div className='col col--4'>
          <div className={styles.title_left}>
            ...
            <div className={styles.subtitle}></div>
            <div className={styles.desc}>可自由定制、修改并集成至现有系统</div>
            <div className={styles.desc}>掌握AI战略主动权，数据主权零风险</div>
            {/* <Link
              key='start'
              className={clsx(
                'button--primary',
        ...
        <div className='col col--4'>
          <div className={styles.title_left}>
            <div className={styles.fisrttitle}><abbr className={styles.fontcolor}>协作式生态创新</abbr></div>
            <div className={styles.subtitle}></div>
            <div className={styles.desc}>鼓励第三方开发者与企业共建</div>
            <div className={styles.desc}>通过社区协作快速集成前沿技术</div>
            {/* <Link
              key='start'
              className={clsx(
                'button--primary',
